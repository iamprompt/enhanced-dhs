...
const App = () => {
  ...
  const fontFamilySelHandler = (e: ChangeEvent<HTMLSelectElement>) =>
    setSelectedOpt((prev) => ({ ...prev, fontFamily: e.target.value }))
  ...
  console.log(FontCategoryOptions)
      ...
      {activeTab?.url?.search('hotstar.com') !== -1 ? (
        <div id='content' className='p-3 flex flex-col space-y-3'>
          ...
          <div id='additional-settings'>
            <h3 className='font-bold text-lg text-gray-900'>{chrome.i18n.getMessage('popupAdditionalSettingTitle')}</h3>
        ...
        <div className='p-3 flex flex-col space-y-3 justify-center items-center'>
          ...
          <button
            className='bg-gradient-to-r bg-blue-700 hover:bg-blue-200 hover:text-blue-900 px-3 py-2 font-bold text-white rounded-full'
            onClick={() => {
